...
richness_comp <- ggplot(diversity_data, aes(x = region, y = richness, fill = method)) +
  geom_boxplot() +
  labs(x = "Region", y = "Richness (Species-level)", pattern = "Survey method") +
  scale_fill_manual(values = c("eDNA" = "deepskyblue4", "Visual" = "darkseagreen"))+
  theme_classic() +
  scale_x_discrete(limits = country_order) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "none")

richness_comp_overall <- ggplot(diversity_data, aes(x = method, y = richness, fill = method)) +
  geom_boxplot()+
  geom_line(aes(group=site), colour = "grey50") +
  scale_fill_manual(values = c("eDNA" = "deepskyblue4", "Visual" = "darkseagreen"))+
  geom_jitter(color="black", size=0.9, alpha=0.9, width = 0.1, height = 0.1) +
  labs(x = "Method", y = "Richness (Species-level)") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "none")
```
...
richness_comp_genus <- ggplot(diversity_data_genus, aes(x = region, y = richness, fill = method)) +
  geom_boxplot() +
  labs(x = "Region", y = "Richness (Genus-level)", pattern = "Survey method") +
  scale_fill_manual(values = c("eDNA" = "deepskyblue4", "Visual" = "darkseagreen"))+
  theme_classic() +
  scale_x_discrete(limits = country_order) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
...
richness_comp_overall_genus <- ggplot(diversity_data_genus, aes(x = method, y = richness, fill = method)) +
  geom_boxplot()+
  geom_line(aes(group=site), colour = "grey50") +
  scale_fill_manual(values = c("eDNA" = "deepskyblue4", "Visual" = "darkseagreen"))+
  geom_jitter(color="black", size=0.9, alpha=0.9, width = 0.1, height = 0.1) +
  labs(x = "Method", y = "Richness (Genus-level)") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "none")
```
...
# colour by method
richness_comp_family <- ggplot(diversity_data_family, aes(x = region, y = richness, fill = method)) +
  geom_boxplot() +
  labs(x = "Region", y = "Richness (Family-level)", pattern = "Survey method") +
  scale_fill_manual(values = c("eDNA" = "deepskyblue4", "Visual" = "darkseagreen"))+
  theme_classic() +
  scale_x_discrete(limits = country_order) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
...
richness_comp_overall_family <- ggplot(diversity_data_family, aes(x = method, y = richness, fill = method)) +
  geom_boxplot() +
  geom_line(aes(group = site), colour = "grey50") +
  geom_jitter(
    color = "black",
  ...
  scale_fill_manual(
    values = c("eDNA" = "deepskyblue4", "Visual" = "darkseagreen")) +
  labs(x = "Method", y = "Richness (Family-level)") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        legend.position = "none")
```
...
legend_plot <- richness_comp_overall_family +
  theme(legend.position = "bottom") +
  scale_fill_manual(values = c("eDNA" = "deepskyblue4", "Visual" = "darkseagreen"), name = "Method") +
...
ggsave(filename = "Figures/alpha_comp_plot.png",
       plot = alpha_comp_plot, device = "png", dpi = 300, units = "mm", height = 150, width = 300)
...
#| label: plot-richness-together-simple

alpha_comp_plot_overall <- cowplot::plot_grid(richness_comp_overall, richness_comp_overall_genus,richness_comp_overall_family, labels = c("a", "b", "c"), ncol = 3)

ggsave(filename = "Figures/alpha_comp_plot_overall.png",
       plot = alpha_comp_plot_overall, device = "png", dpi = 300, units = "mm", height = 150, width = 300)

alpha_comp_plot_overall
```

All alpha diversity together.

```{r}

alpha_all <- cowplot::plot_grid(
  cowplot::plot_grid(richness_comp_overall, richness_comp_overall_genus,richness_comp_overall_family,richness_comp, richness_comp_genus,richness_comp_family, labels = c("a", "b", "c", "d", "e", "f"), ncol = 3), legend, ncol =1, rel_heights = c(1, 0.06))

ggsave(filename = "Figures/alpha_all.png",
       plot = alpha_all, device = "png", dpi = 300, units = "mm", height = 250, width = 250)
