...
ord.nmds.jaccard <- ordinate(direct_phylo_sp, method = "NMDS", distance =
                                   "jaccard")
...
NMDS_method_jaccard <- plot_ordination(direct_phylo_sp, ord.nmds.jaccard, color="Method")+
  theme_classic()+ 
...
nmds_sp <- metaMDS(community_matrix_sp, distance = "jaccard", k = 2, trymax = 100)
