...
species_all <- cowplot::plot_grid(sp1_plot, sp2_plot, sp3_plot, sp4_plot, sp5_plot, sp6_plot, sp7_plot, ncol = 7, labels = c("a", "b", "c", "d", "e", "f", "g"))

ggsave(plot = species_all, filename = "Figures/changing_species_comp_plot.png", device = "png", dpi = 300, units = "mm", height = 200, width = 400)
